...
v0.1.8 完成。24 个 CLI 命令，5 个 Agent 双通道覆盖，**183 个成就**，**990 个测试全绿（39 文件）**。
...
| CLI 命令 | 3 个 | 24 个命令（含 uninstall/export/import/config/showcase/search/suggest/profile softwares） |
