...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/업적-218-blueviolet" alt="218 업적"></a>
  <a href="#"><img src="https://img.shields.io/badge/테스트-1203-green" alt="1203 테스트"></a>
  ...
  <a href="#"><img src="https://img.shields.io/badge/CLI-25_명령어-orange" alt="25 CLI 명령어"></a>
...
- **218개 업적**, 11개 카테고리 — "Hello World"부터 "컴플리셔니스트"까지
...
두 채널 모두 동일한 `~/.agent-achievements/` 이벤트 로그에 기록합니다. 엔진은 12가지 조건 유형으로 218개 업적을 평가합니다.
...
- 🏆 **218개 업적**, 11개 카테고리 (온보딩, 도구 숙련, 마일스톤, 스킬, 스타일, 워크플로우, 크리에이터, 히든, 챌린지, 커뮤니티, 인내)
...
achievement-definitions.yaml   # 218개 업적 정의 (권위적 소스)
...
<p align="center">
  <sub>게임화를 사랑하는 개발자를 위해 만들어졌습니다. 218개의 업적, 계속 증가 중.</sub>
</p>
