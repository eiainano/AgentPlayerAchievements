...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/成就-171-blueviolet" alt="171 成就"></a>
  <a href="#"><img src="https://img.shields.io/badge/测试-519-green" alt="519 测试"></a>
  <a href="#"><img src="https://img.shields.io/badge/node-%E2%89%A518-brightgreen" alt="Node >= 18"></a>
  <a href="#"><img src="https://img.shields.io/badge/CLI-19_命令-orange" alt="19 命令"></a>
</p>
...
两个通道写入同一份 `~/.agent-achievements/` 事件日志。引擎用 11 种条件类型评估 171 个成就。

## 功能特性

- 🎮 **成就 Dashboard** — XP 进度条、等级、连续天数、活跃热力图、稀有度分布、展示柜
- 🏆 **171 个成就** — 覆盖 10 个分类（入门、工具精通、里程碑、技能、风格、工作流、创造者、隐藏、挑战、社区）
...
全部 5 个工具均有双通道覆盖（Hermes 除外，仅 MCP）。
...
| 2 | 工具精通 (Tool Mastery) | 30 | Read/Edit/Bash 技能门槛 |
| 3 | 里程碑 (Milestones) | 18 | 任务数、连续天数、Token 消耗 |
| 4 | 技能 (Skill) | 14 | 链式反应、捉虫、一发入魂 |
| 5 | 风格 (Style) | 10 | 极简主义、夜猫子、Ctrl C+V 之王 |
| 6 | 工作流 (Workflow) | 19 | PR、CI/CD、Code Review、Merge Conflict |
| 7 | 创造者 (Creator) | 9 | 斜杠命令、技能、自定义 Agent、Hook |
| 8 | 隐藏 (Hidden) | 20 | 彩蛋和惊喜解锁 |
| 9 | 挑战 (Challenge) | 10 | 速通、多模型、零编辑连击 |
| 10 | 社区 (Community) | 10 | 完美主义等级、跨工具收集者 |
...
04-成就定义清单.yaml          # 171 个成就定义（权威数据源）
...
- **运行时** (3): `@modelcontextprotocol/sdk` · `yaml` · `zod`
...
<p align="center">
  <sub>为喜爱游戏化的开发者而建。171 个成就，还在增长中。</sub>
</p>
