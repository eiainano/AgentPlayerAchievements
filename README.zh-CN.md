...
- **213 个成就**，覆盖 11 个类别——从「Hello World」到「完美主义者」
...
两个通道都写入同一个 `~/.agent-achievements/` 事件日志。引擎用 12 种条件类型评估 213 个成就。
...
- 🏆 **213 个成就**，11 个类别（入门、工具精通、里程碑、技能、风格、工作流、创造者、隐藏、挑战、社区、耐力）
...
<p align="center">
  <sub>为热爱游戏化的开发者而建。213 个成就，持续更新中。</sub>
</p>
