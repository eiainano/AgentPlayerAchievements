...
- 🏆 **217개 업적**, 11개 카테고리 — "Hello World"부터 "컴플리셔니스트"까지
- 🔥 **GitHub 스타일 활동 히트맵** — 4개월간의 코딩 활동을 한눈에
- 📸 **공유 카드** — 다크/라이트 테마, 이중언어, PNG 다운로드 가능
- 🔊 **8비트 사운드 효과 및 알림** — 해제 시 희귀도별 레트로 사운드 + 데스크톱 푸시 알림
- 📂 **다중 프로필** — 최대 4개 프로필, 언제든지 전환 가능 (업무, 개인, 실험)
...
| `agpa profile` | 업적 프로필 관리 (생성, 목록, 전환, 소프트웨어, 삭제) |
...
| `agpa sound` | 8비트 희귀도별 사운드 효과 전환 (on, off) |
...
취약점을 신고하려면 [SECURITY.md](SECURITY.md)를 참조하세요.

## 👥 기여하기

기여를 환영합니다! 업적 팩, 대시보드 개선, 새로운 도구 통합, 엔진 수정 등 모든 기술 수준에 맞는 참여 방법이 있습니다.

- **[CONTRIBUTING.md](CONTRIBUTING.md)** — 설정, 코딩 규칙, PR 프로세스 및 4가지 기여 경로
- **[업적 팩 생성 가이드](docs/creating-achievements.md)** — 업적 정의 작성에 대한 완전한 가이드
- **[`.github/ISSUE_TEMPLATE/`](.github/ISSUE_TEMPLATE/)** — 이슈 및 PR 템플릿
